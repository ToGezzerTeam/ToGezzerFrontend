...
import { login } from '@/api/route/login.ts'
      ...
      >
        <div class="relative min-h-56 bg-primary p-7 text-primary-content sm:min-h-0 sm:p-10">
          <div class="absolute right-6 top-6">
            <RouterLink
              class="btn btn-sm btn-outline border-primary-content/35 text-primary-content hover:bg-primary-content/15"
              to="/"
            >
              Retour
            </RouterLink>
          ...
          <div class="max-w-sm space-y-4">
            ...
            <p class="text-primary-content/75">
              Connecte-toi pour retrouver tes salons textuels et vocaux, ton historique, et tes
              équipes en un clic.
            </p>
          </div>
        </div>
        ...
        <div class="p-6 sm:p-10">
          <div class="mb-7 space-y-2">
            ...
            <p class="text-sm text-base-content/65">
              Utilise ton e-mail et ton mot de passe pour accéder à ToGezzer.
            </p>
          </div>
          ...
          <p class="mt-4 text-center text-sm text-base-content/70">
            ...
            <RouterLink class="link link-hover link-primary font-medium" to="/register"
